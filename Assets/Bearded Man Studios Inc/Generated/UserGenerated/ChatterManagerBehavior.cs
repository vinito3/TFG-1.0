...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"message\", \"username\"]]")]
	public abstract partial class ChatterManagerBehavior : NetworkBehavior
	{
		public const byte RPC_TRANSMIT_MESSGAE = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("TransmitMessgae", TransmitMessgae, typeof(string), typeof(string));
		...
		/// string username
		/// </summary>
		public abstract void TransmitMessgae(RpcArgs args);
